...
export class JasminService {
    ...
    public getCustomers(calback): void {
        ...
        uriParts[3] = "customerParties";

        var getCustomersUrl = this.formatString(this.settingsService.jasminApiUri, uriParts);

        var xhttp = new XMLHttpRequest();
        xhttp.open("GET", getCustomersUrl, true);
